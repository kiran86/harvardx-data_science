...
# grouping and then summarising in data.table
...
# order by population in decending order
...
# compare what happens when accessing a column
# that doesn't exist in a regular data frame to in a tibble
murders$State
